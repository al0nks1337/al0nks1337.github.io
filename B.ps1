Clear-Host
Start-Process -FilePath "changepk.exe" -ArgumentList "/ProductKey NPPR9-FWDCX-D2C8J-H872K-2YT43" -NoNewWindow -Wait -RedirectStandardOutput $null -RedirectStandardError $null
